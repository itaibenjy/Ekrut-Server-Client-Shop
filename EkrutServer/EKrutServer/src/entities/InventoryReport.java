...
public class InventoryReport extends Report implements Serializable {
	...
	public String toString() {
		return "InventoryReport [facilityID=" + facilityID + ", tempFacilitieInventory=" + tempFacilitieInventory
				+ ", passThresholdMax=" + passThresholdMax + ", countNotPassed=" + countNotPassed
				+ ", numOfTotalProducts=" + numOfTotalProducts + ", facilitieInventory=" + facilitieInventory
				+ ", passedThresHold=" + passedThresHold + ", toString()=" + super.toString() + "]";
	}
