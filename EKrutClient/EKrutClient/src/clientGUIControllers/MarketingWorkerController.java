...
public class MarketingWorkerController {
	...
	private void initialize() {
		...
		setImages();
		setUserInformation();
		this.welcomeToMarketingWorkerLabel.setText(
	...
	/**
	 * Clicking this button will take me to the inventory update screen.
	 * @param event
	 */
	@FXML
	void InventoryUpdate_Pressed(ActionEvent event) {
		commonActionsController.backOrNextPressed(event, "/clientGUIScreens/MarketingWorkerSalesScreen.fxml");
